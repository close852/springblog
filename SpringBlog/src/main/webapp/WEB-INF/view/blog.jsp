...
<!--     <header class="intro-header" style="background-image:url('/static/images/home.jpg')"> -->
	...
	<script type="text/javascript" src="/webjars/origoni-startbootstrap-clean-blog/1.0.3/js/clean-blog.min.js"></script>
</body>
</html>
